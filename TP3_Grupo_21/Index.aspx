<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="TP3_Grupo_21._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style5">
                <asp:TextBox ID="txtNombreLocalidad" runat="server" Width="139px"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator 
             ID="rfvNombreLocalidad" 
             runat="server" 
        ...
        <tr>
            <td id="tblFormulario" class="auto-style4"></td>
            <td id="tblFormulario" class="auto-style6">
                <asp:Button ID="btnGuardarLocalidad" runat="server" Text="Guardar Localidad" OnClick="btnGuardarLocalidad_Click" />
            </td>
            <td id="tblFormulario" class="auto-style2"></td>
            <td id="tblFormulario" class="auto-style2"></td>
            <td id="tblFormulario" class="auto-style2"></td>
            <td id="tblFormulario" class="auto-style2"></td>
            <td id="tblFormulario" class="auto-style2"></td>
